...
import GetterSetterPrimitives from "./1getterSetter";
...
const primitives = [GetterSetterPrimitives, DataStructPrimitives, CommunicationPrimitives, ArithmeticPrimitives, LogicalPrimitives];
